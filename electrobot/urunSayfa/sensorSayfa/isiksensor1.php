    ...
    <div class="container my-5">
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./sensorimage/4.jpg" class="d-block w-100" alt="isiksensor14">
                                </div>
                                <div class="carousel-item">
                                    <img src="./sensorimage/4-1.jpg" class="d-block w-100" alt="isiksensor14-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="./sensorimage/4-2.jpg" class="d-block w-100" alt="isiksensor14-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="LDR Işık Sensörü Kartı (3 Pin)" readonly></h1>
                    <p>Ortam ışığına göre dijital çıkış veren bu kart karanlık durumda 0V, sensör üzerine ışık düştüğü durumda ise 5V sinyal vermektedir.</p>
                    <hr>

                    <h6>Urun Ozellikleri</h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                            Üzerindeki pot ile hassasiyet ayarı yapılabilir.
                        </li>
                        <li class="text-muted">
                            Çalışma gerilimi 5V'tur.
                        </li>
                    </ul>
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="6" readonly> ₺</h2>
