    ...
    <div class="container my-5">
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./sensorimage/3.jpg" class="d-block w-100" alt="kizilotesisensor13">
                                </div>
                                <div class="carousel-item">
                                    <img src="./sensorimage/3-1.jpg" class="d-block w-100" alt="kizilotesisensor13-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="./sensorimage/3-2.jpg" class="d-block w-100" alt="kizilotesisensor13-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="TCRT5000 Kızılötesi Sensör" readonly></h1>
                    <p>TCRT5000 çizgi ve cisim sensörü olarak çizgi izleyen, sumo, mini sumo başta olmak üzere bir çok robotik ve elektronik projede kullanabileceğiniz kızılötesi sensördür.</p>
                    <hr>

                    <h6>Urun Ozellikleri</h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                            0,2mm ile 15mm  arasında sağlıklı şekilde çalışmaktadır.
                        </li>
                    </ul>
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="1.25" readonly> ₺</h2>
