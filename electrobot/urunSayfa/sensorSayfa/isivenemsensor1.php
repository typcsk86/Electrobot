    ...
    <div class="container my-5">
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./sensorimage/2.jpg" class="d-block w-100" alt="isivenemsensor12">
                                </div>
                                <div class="carousel-item">
                                    <img src="./sensorimage/2-1.jpg" class="d-block w-100" alt="isivenemsensor12-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="./sensorimage/2-2.jpg" class="d-block w-100" alt="isivenemsensor12-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="DHT11 Isı ve Nem Sensörü Kart" readonly></h1>
                    <p>DHT11 sıcaklık ve nem algılayıcı kalibre edilmiş dijital sinyal çıkışı veren gelişmiş bir algılayıcı birimidir.</p>
                    <hr>

                    <h6>Urun Ozellikleri</h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                            8 bit mikroişlemci içerir, hızlı ve kaliteli tepki verir.
                        </li>
                        <li class="text-muted">
                            0 ile 50°C arasında 2°C hata payı ile sıcaklık ölçen birim, 20-90% RH arasında 5% RH hata payı ile nem ölçer.
                        </li>
                    </ul>
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="11.50" readonly> ₺</h2>
