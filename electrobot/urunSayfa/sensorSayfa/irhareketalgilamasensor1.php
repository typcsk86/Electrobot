        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./sensorimage/1.jpg" class="d-block w-100" alt="irhareketalgilamasensor11">
                                </div>
                                <div class="carousel-item">
                                    <img src="./sensorimage/1-1.jpg" class="d-block w-100" alt="irhareketalgilamasensor11-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="./sensorimage/1-2.jpg" class="d-block w-100" alt="irhareketalgilamasensor11-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepeteekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="HC-SR501 Ayarlanabilir IR Hareket Algılama Sensörü" readonly></h1>
                    <p>PIR sensörleri, bir ortamda oluşan canlı hareketini algılamak için kullanılan sensörlerdir.</p>
                    <hr>
                    ...
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="8.88" readonly> ₺</h2>
