    ...
    <div class="container my-5">
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./sensorimage/0.jpg" class="d-block w-100" alt="ultrasonikmesafesensor10">
                                </div>
                                <div class="carousel-item">
                                    <img src="./sensorimage/0-1.jpg" class="d-block w-100" alt="ultrasonikmesafesensor10-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="./sensorimage/0-2.jpg" class="d-block w-100" alt="ultrasonikmesafesensor10-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="HC-SR04 Ultrasonik Mesafe Sensörü" readonly></h1>
                    <p>2cm'den 400cm'ye kadar 3mm hassasiyetle ölçüm yapabilen bu ultrasonik sensör çeşididir. Uzaklık okuma, radar ve robot uygulamalarında kullanılabilir.</p>
                    <hr>
                    ...
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="7.50" readonly> ₺</h2>
