        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./raspberryimage/2.jpg" class="d-block w-100" alt="raspberrypi412">
                                </div>
                                <div class="carousel-item">
                                    <img src="./raspberryimage/2-1.jpg" class="d-block w-100" alt="raspberrypi412-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="./raspberryimage/2-2.jpg" class="d-block w-100" alt="raspberrypi412-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepeteekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Raspberry Pi 4 8GB" readonly></h1>
                    <p>Raspberry Pi 4, bir önceki model olan Raspberry Pi 3B+ üzerine oldukça fazla yenilik ile geliyor. İlk dikkat çeken özelliği önceki modelde 1GB ve LPDDR2 tipindeki RAM belleğin 2GB, 4GB ve 8GB LPDDR4-3200 seçenekleri ile gelmesi.</p>
                    <hr>
                    ...
                    <ul class="unstyled">
                        ...
                        <li class="text-muted">
                            4/5.0 GHz 802.11ac destekli kablosuz ağ, Bluetooth 5.0, BLE destekli
                        </li>
                        <li class="text-muted">
                    ...
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="799" readonly> ₺</h2>
