        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepeteekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Raspberry Pi 2 Model B" readonly></h1>
                    <p>Raspberry Pi kredi kartı boyutunda bir mini bilgisayar kartıdır. Üstelik sadece birkaç dakikaya kurulumunu yapıp kullanmaya başlayabilirsiniz.</p>
                    <hr>
                    ...
                    <ul class="unstyled">
                        ...
                        <li class="text-muted">
                            2.4GHz ve 5GHz destekli IEEE 802.11.b/g/n/ac kablosuz ağ bağlantısı, Bluetooth 4.2, BLE destekli
                        </li>
                        <li class="text-muted">
                            USB 2.0 üzerinden gigabit Ethernet (maks. hız 300 Mbps)
                        </li>
                        <li class="text-muted">
                            Genişletilmiş 40-pin GPIO header bağlantısı
                        </li>
                    </ul>
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="370" readonly> ₺</h2>
