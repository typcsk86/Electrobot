        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./raspberryimage/1.jpg" class="d-block w-100" alt="raspberrypizero11">
                                </div>
                                <div class="carousel-item">
                                    <img src="./raspberryimage/1-1.jpg" class="d-block w-100" alt="raspberrypizero11-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="./raspberryimage/1-2.jpg" class="d-block w-100" alt="raspberrypizero11-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepeteekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Raspberry Pi Zero" readonly></h1>
                    <p>Bugüne kadar üretilen en küçük boyutlu bilgisayar Raspberry Pi Zero ile tanışmaya hazır olun! Raspberry Pi serisinin en kullanışlı modellerinden olan Raspberry Pi Zero ile birçok projeyi hayata geçirebilirsiniz.</p>
                    <hr>

                    <h6>Urun Ozellikleri</h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                            A Broadcom BCM2835 İşlemci 1GHz ARM11 çekirdek (Raspberry Pi 1 modelinden 40% daha hızlı)
                        </li>
                        <li class="text-muted">
                            512MB LPDDR2 SDRAM
                        </li>
                        ...
                        <li class="text-muted">
                            1080p60 Mini-HDMI video çıkışı
                        </li>
                        <li class="text-muted">
                            Mikro-USB soket
                        </li>
                    </ul>
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="44.99" readonly> ₺</h2>
