        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./gelistirmekartimage/3.jpg" class="d-block w-100" alt="roboshieldgelistirme13">
                                </div>
                                <div class="carousel-item">
                                    <img src="./gelistirmekartimage/3-1.jpg" class="d-block w-100" alt="roboshieldgelistirme13-1">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepeteekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="RoboShield Arduino Robot Shield" readonly></h1>
                    <p>RoboShield Arduino Robot Shield kartı ile küçük ve orta ölçekli robotları ekstra bağlantılara gerek duymadan üzerinde bulunan hazır bileşenler ile gerçekleştirmeniz mümkün olacaktır.</p>
                    <hr>

                    <h6>Urun Ozellikleri</h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                            Çalışma Gerilimi: 6 -12VDC
                        </li>
                        <li class="text-muted">
                            Çalışma Akımı (Boşta): 10 mA
                        </li>
                        <li class="text-muted">
                            Motor Çıkışları: Sürekli 600mA (Kanal Başına)
                        </li>
                        <li class="text-muted">
                            Motor Anlık Çıkış Akımı: 1A (Kanal Başına)
                        </li>
                        <li class="text-muted">
                            Dahili LDR Sensörleri (LDR).
                        </li>
                    </ul>
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="79.21" readonly> ₺</h2>
