        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./gelistirmekartimage/0.jpg" class="d-block w-100" alt="nodemcugelistirme10">
                                </div>
                                <div class="carousel-item">
                                    <img src="./gelistirmekartimage/0-1.jpg" class="d-block w-100" alt="nodemcugelistirme10-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="./gelistirmekartimage/0-2.jpg" class="d-block w-100" alt="nodemcugelistirme10-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepeteekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="NodeMCU LoLin ESP8266 Geliştirme Kartı" readonly></h1>
                    <p>LoLin, üzerinde NodeMCU firmware yüklü ESP8266 WiFi modül barındıran bir geliştirme kartıdır. ESP8266 SDK'sı kullanılarak geliştirildiğinden, ekstradan bir mikrokontrolcüye ihtiyaç duymadan GPIO, PWM, IIC, 1-Wire ve ADC bağlantılarını destekler.</p>
                    <hr>
                    ...
                    <ul class="unstyled">
                        ...
                        <li class="text-muted">
                            json, file, timer, pwm, i2c, spi, 1-wire, net, mqtt, coap, gpio, wifi, adc, uart ve system api destekler
                        </li>
                    </ul>
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="33.44" readonly> ₺</h2>
