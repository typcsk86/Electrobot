        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./gelistirmekartimage/1.jpg" class="d-block w-100" alt="mebstartgelistirme11">
                                </div>
                                <div class="carousel-item">
                                    <img src="./gelistirmekartimage/1-1.jpg" class="d-block w-100" alt="mebstartgelistirme11-1">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepeteekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="MEBSTART MEB Robot Yarışması Başlatma Modülü" readonly></h1>
                    <p>MEBSTART MEB Robot Yarışması Başlatma Modülü yarışmalarda sumo robot, çizgi izleyen robot, labirent robotlarını uzaktan aktif etmenize yardımcı olacaktır.</p>
                    <hr>

                    <h6>Urun Ozellikleri</h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                            MEBSTART MEB Robot Yarışması Başlatma Modülü tüm ID kumandalar ile uyumludur.
                        </li>
                    </ul>
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="38" readonly> ₺</h2>
