        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./aracgerecimage/6.jpg" class="d-block w-100" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="./aracgerecimage/6-1.jpg" class="d-block w-100" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="./aracgerecimage/6-2.jpg" class="d-block w-100" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepeteekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Proskit Eğri Uçlu, Ufak Metal Cımbız 1PK-104T" readonly></h1>
                    <p>İnce ve eğri uçlu metal cımbız (mıknatıssız) sizlere yoğun elektronik kart veya projelerinizde rahat çalışabilme kolaylığı sağlayacaktır. Ürünün uzunluğu 120mm'dir.</p>
                    <hr>
                    ...
                    <ul class="unstyled">
                        ...
                        <li class="text-muted">
                            Özellikle dar çalışma alanlarında kullanılabilen ince ve açılı bir uca sahiptir.
                        </li>
                    </ul>
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="35" readonly> ₺</h2>
