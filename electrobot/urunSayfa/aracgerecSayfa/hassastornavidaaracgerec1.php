        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./aracgerecimage/0.jpg" class="d-block w-100" alt="hassastornavidaaracgerec10">
                                </div>
                                <div class="carousel-item">
                                    <img src="./aracgerecimage/0-1.jpg" class="d-block w-100" alt="hassastornavidaaracgerec10-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="./aracgerecimage/0-2.jpg" class="d-block w-100" alt="hassastornavidaaracgerec10-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepeteekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="SD-9815 HASSAS TORNAVİDA SETİ (6pcs)" readonly></h1>
                    <p>Pro'skit SD-9815 Hassas tornavida seti Cıvata sürücü Çok fonksiyonlu ev tornavida seti.</p>
                    <hr>

                    <h6>Urun Ozellikleri</h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                            Pro'sKit SD-9815 tornavida seti (6 pcs.)
                        </li>
                        <li class="text-muted">
                            -Slotted slot: 1.4 / 1.8 / 2.4 / 3.0 mm
                        </li>
                        <li class="text-muted">
                            -Phillips head cross: #0 / #1
                        </li>
                        <li class="text-muted">
                            Plastik kutu (1 pc.)
                        </li>
                    </ul>
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="64" readonly> ₺</h2>
