        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./aracgerecimage/4.jpg" class="d-block w-100" alt="jumperkutuluaracgerec14">
                                </div>
                                <div class="carousel-item">
                                    <img src="./aracgerecimage/4-1.jpg" class="d-block w-100" alt="jumperkutuluaracgerec14-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="./aracgerecimage/4-2.jpg" class="d-block w-100" alt="jumperkutuluaracgerec14-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepeteekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="140 Parça Kutulu Jumper Kablo Kiti" readonly></h1>
                    <p>14 farklı boyda kesilip uçları açılmış 140 parça jumper kablo kitidir.</p>
                    <hr>
                    ...
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="15.32" readonly> ₺</h2>
