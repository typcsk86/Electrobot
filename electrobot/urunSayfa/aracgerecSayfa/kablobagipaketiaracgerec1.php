        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./aracgerecimage/5.jpg" class="d-block w-100" alt="kablobagipaketiaracgerec15">
                                </div>
                                <div class="carousel-item">
                                    <img src="./aracgerecimage/5-1.jpg" class="d-block w-100" alt="kablobagipaketiaracgerec15-1">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepeteekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Küçük Kablo Bağı Paketi (Plastik Kelepçe)" readonly></h1>
                    <p>100'lü paket halindedir. Kablo bağları 150mm(15cm) boyundadır.</p>
                    <hr>

                    <h6>Urun Ozellikleri</h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                            Kabloları bir araya toplamak ve sıkıştırmak için kullanılabilir.
                        </li>
                        <li class="text-muted">
                            Paket dahilinde 100 adet kablo bağı bulunmaktadır.
                        </li>
                        <li class="text-muted">
                            150mm uzunluğundadır.
                        </li>
                    </ul>
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="9.99" readonly> ₺</h2>
