    ...
    <div class="container my-5">
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./aracgerecimage/2.jpg" class="d-block w-100" alt="jumperaracgerec12">
                                </div>
                                <div class="carousel-item">
                                    <img src="./aracgerecimage/2-1.jpg" class="d-block w-100" alt="jumperaracgerec12-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="./aracgerecimage/2-2.jpg" class="d-block w-100" alt="jumperaracgerec12-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="40 Pin Dişi-Erkek Jumper Kablo" readonly></h1>
                    <p>Bu bağlantı kabloları 2,54 mm'lik standart pinlere göre dizayn edilmiştir. Toplam 10 renk ve her renkten 4 adet olmak üzere toplam 40 adetlik paket halindedir. Bu 26 awg'lik bağlantı kablolarının boyu 20 cm'dir. Bir ucu dişi, diğeri erkek jumper kablodur.</p>
                    <hr>
                    ...
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="5" readonly> ₺</h2>
