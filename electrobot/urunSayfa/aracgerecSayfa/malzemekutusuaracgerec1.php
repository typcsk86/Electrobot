        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./aracgerecimage/3.jpg" class="d-block w-100" alt="malzemekutusuaracgerec13">
                                </div>
                                <div class="carousel-item">
                                    <img src="./aracgerecimage/3-1.jpg" class="d-block w-100" alt="malzemekutusuaracgerec13-1">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepeteekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Mano Şeffaf Malzeme Kutusu" readonly></h1>
                    <p>276mm x 203mm x 42mm boyutlarındadır. Şeffaf renklidir.</p>
                    <hr>

                    <h6>Urun Ozellikleri</h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                            20 adet ufak bölme ve 1 adet de büyük bölmeye sahiptir.
                        </li>
                        <li class="text-muted">
                            Devre elemanlarınızı, çeşitli araç gereçlerinizi bu kutu içerisinde saklayabilirsiniz.
                        </li>
                        <li class="text-muted">
                            Kullanımı rahat, sert, kapaklı yapıdadır.
                        </li>
                    </ul>
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="14.66" readonly> ₺</h2>
