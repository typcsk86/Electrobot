        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepeteekle.php">
                        <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Arduino Uno R3" readonly></h1>
                        <p>Arduino, bilgisayarınız aracılığıyla programlayarak çeşitli elektronik projeler yapabileceğiniz bir mikrokontrolcü platfomudur. Arduino ile robotik projeler, akıllı ev sistemleri, müzik aletleri gibi aklınıza gelebilecek neredeyse tüm
                            elektronik projeleri gerçekleştirmeniz mümkündür.</p>
                        <hr>
                        ...
                        <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="189" readonly> ₺</h2>
