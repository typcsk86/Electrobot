        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepeteekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Arduino Nano" readonly></h1>
                    <p>Android Nano'da USB CH340 Serial Dönüştürücüsü kullanılmıştır.</p>
                    <hr>
                    ...
                    <ul class="unstyled">
                        ...
                        <li class="text-muted">
                            Analog G / Ç: 8 adet pin deliği
                        </li>
                        <li class="text-muted">
                            DC Akım G/Ç Pinleri: 40mA
                        </li>
                        <li class="text-muted">
                            Giriş Voltajı: DC 7V ~ 12V (Tavsiye)
                        </li>
                        <li class="text-muted">
                            Çalışma Voltajı (Lojik): 5V
                        </li>
                    </ul>
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="28" readonly> ₺</h2>
