        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./arduinoimage/1.jpg" class="d-block w-100" alt="arduinopromini1">
                                </div>
                                <div class="carousel-item">
                                    <img src="./arduinoimage/1-1.jpg" class="d-block w-100" alt="arduinopromini1-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="./arduinoimage/1-2.jpg" class="d-block w-100" alt="arduinouno1-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepeteekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Arduino Pro Mini" readonly></h1>
                    <p>Arduino Pro Mini 5V ile çalışan ve üzerinde Atmega328 mikrodenetçisi bulunduran bir geliştirme/prototip kartıdır.</p>
                    <hr>
                    ...
                    <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="19" readonly> ₺</h2>
