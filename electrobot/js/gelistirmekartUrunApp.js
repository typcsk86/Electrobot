...
xmlhttp.open("GET", "xmlFiles/urunGelistirmeKart.xml", false);
xmlhttp.send();
...
for(i=0; i<x.length; i++) {
    div += "<div class='col mb-4' data-aos='fade-up'>";
        div += "<div class='card h-100 border-info mb-2'>";
            div += "<img src='./images/gelistirmekartimage/" + i + ".jpg' class='card-img-top'>";
            ...
            div += "<div class='card-footer bg-transparent'>";
                div += "<a href='./urunSayfa/gelistirmekartSayfa/" +
